...
<div class="max-w-4xl mx-auto">
    ...
    <div id="order-detail" class="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden hidden">
        ...
        <div class="p-6">
            <form action="{{ route('monitoring.track-out.store') }}" method="POST">
                @csrf
                ...
                <div class="mb-6 p-4 bg-indigo-50 rounded-lg border border-indigo-100">
                    ...
                    <div class="flex gap-4">
                        <label class="flex items-center gap-2 cursor-pointer">
                            <input type="radio" name="pickup_method" value="customer" class="text-indigo-600 focus:ring-indigo-500" required>
                ...
                <div class="flex justify-end gap-3 pt-4 border-t border-slate-100">
                    ...
                    <button type="submit" class="px-6 py-2.5 bg-emerald-600 text-white rounded-lg font-medium hover:bg-emerald-700 transition-colors flex items-center gap-2 shadow-sm shadow-emerald-200">
            ...
            $.ajax({
                ...
                success: function(res) {
                    ...
                    res.items.forEach(item => {
                        ...
                        let checkHtml = '';
                        if (item.can_track_out) {
                            checkHtml = `<input type="checkbox" name="item_ids[]" value="${item.id}" class="item-checkbox rounded border-slate-300 text-emerald-600 focus:ring-emerald-500">`;
                            canTrackOutAny = true;
                        } else {
                        ...
                        tbody.append(`
                            <tr class="${item.can_track_out ? 'hover:bg-emerald-50/30' : 'bg-slate-50/50 opacity-75'}">
                    ...
                    $('#check-all').prop('checked', false).prop('disabled', !canTrackOutAny);
