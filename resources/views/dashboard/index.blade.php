...
@section('content')
    <div class="grid gap-6 lg:grid-cols-3">
        <div class="lg:col-span-2 grid gap-6 sm:grid-cols-3">
            <div class="rounded-2xl bg-white p-6 shadow-sm border border-slate-200">
                ...
                <p class="mt-3 inline-flex items-center rounded-full bg-indigo-50 px-3 py-1 text-xs font-medium text-indigo-600">
                    {{ $data['today']['transactions'] }} transaksi
                </p>
            </div>
            <div class="rounded-2xl bg-white p-6 shadow-sm border border-slate-200">
                <p class="text-sm text-slate-500">Profit Hari Ini</p>
                <p class="mt-2 text-3xl font-semibold text-emerald-600">
                    Rp {{ number_format($data['today']['profit'], 0, ',', '.') }}
                </p>
                <p class="mt-3 text-xs text-emerald-600">Profit bersih setelah diskon</p>
            </div>
            <div class="rounded-2xl bg-white p-6 shadow-sm border border-slate-200">
                ...
                <p class="mt-3 text-xs text-slate-500">Nominal per transaksi</p>
            </div>
        </div>
        <div class="lg:col-span-1 rounded-2xl bg-gradient-to-br from-indigo-500 to-indigo-600 p-6 text-white shadow-lg">
            <p class="text-sm opacity-80">Quick Insight</p>
            <h2 class="mt-4 text-2xl font-semibold">Penjualan stabil</h2>
    ...
    <div class="mt-6 grid gap-6 lg:grid-cols-3">
        <div class="lg:col-span-2 rounded-2xl bg-white p-6 shadow-sm border border-slate-200">
            <div class="flex items-center justify-between">
                <div>
                    <h2 class="text-lg font-semibold text-slate-800">Grafik Penjualan 7 Hari</h2>
                    <p class="text-sm text-slate-500">Tren penjualan harian minggu ini</p>
                </div>
            </div>
            <div class="mt-6">
        ...
        <div class="rounded-2xl bg-white p-6 shadow-sm border border-slate-200">
            <h2 class="text-lg font-semibold text-slate-800">Produk Terlaris</h2>
            <p class="text-sm text-slate-500">Periode 30 hari terakhir</p>
    ...
    <div class="mt-6 grid gap-6 lg:grid-cols-2">
        <div class="rounded-2xl bg-white p-6 shadow-sm border border-slate-200">
            <h2 class="text-lg font-semibold text-slate-800">Stok Produk</h2>
            <p class="text-sm text-slate-500">Pantau stok kritis dan stok aman</p>
        ...
        <div class="rounded-2xl bg-white p-6 shadow-sm border border-slate-200">
            <h2 class="text-lg font-semibold text-slate-800">Catatan</h2>
            <p class="text-sm text-slate-500">Tips operasional kasir hari ini</p>
            ...
            <a href="{{ route('reports.sales') }}" class="mt-5 inline-flex items-center gap-2 rounded-full bg-indigo-600 px-4 py-2 text-sm font-semibold text-white shadow hover:bg-indigo-500">
